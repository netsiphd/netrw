...
3. In order for your contribution to have automated documentation
   ...
   `netrw/doc/source/distance.rst`. (Or
   `netrw/doc/source/reconstruction.rst`). Under the 'Available distances'
...
5. If you need other auxiliary files, we got you covered! Place your
   Jupyter notebooks in the `netrw/notebooks` folder, and any data files
   you may need in the `netrw/data` folder. If you are willing to write a
   short documentation file (this may be plain text, a notebook, latex,
   etc) place that inside `netrw/docs`.
